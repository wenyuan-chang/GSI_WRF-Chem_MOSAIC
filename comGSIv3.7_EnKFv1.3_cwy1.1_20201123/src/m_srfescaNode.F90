...
! module interface:
  ...
  type,extends(obsNode):: srfescaNode
  ...
  end type srfescaNode

  public:: srfescaNode_typecast
  public:: srfescaNode_nextcast
        interface srfescaNode_typecast; module procedure typecast_ ; end interface
        interface srfescaNode_nextcast; module procedure nextcast_ ; end interface

  character(len=*),parameter:: MYNAME="m_srfescaNode"
...
subroutine obsNode_clean_(aNode)
  implicit none
  class(srfescaNode),intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(srfescaNode),intent(in):: aNode
