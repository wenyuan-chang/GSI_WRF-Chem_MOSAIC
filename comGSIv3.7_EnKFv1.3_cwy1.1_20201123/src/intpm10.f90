...
!!! cwy mosaic --------------------------------------- chem
    ...
    use obsmod, only: pm10bufr_only_coarse
!!! cwy mosaic --------------------------------------- chem
...
!!! cwy mosaic ----------------------------------- chem
    real(r_kind)      ::  ual
    integer(i_kind)   ::  ksiz, ksiz_min, kss
    character( len=2 )::  c2
...
!!!    if (wrf_mass_regional) then
    if (wrf_mass_regional .and. .not.laeroana_mosaic) then
!!! cwy mosaic -------------------------------------- chem
      ...
      do while( associated(pm10ptr) )
        ...
        if( n_cvmas/=0 ) then
          do ksiz=kss, nsize_mosaic_wrf
            write(c2,'(i2.2)') ksiz
            call gsi_bundlegetpointer(sval,'mas_a'//c2,spm10,istatus)
            if( istatus==0 ) then 
        ...
        if( n_cvaer/=0 ) then
          do ksiz=kss, nsize_mosaic_wrf
            write(c2,'(i2.2)') ksiz
            call gsi_bundlegetpointer(sval,'so4_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'no3_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'nh4_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'oc_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'bc_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'oin_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'cl_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
            ...
            call gsi_bundlegetpointer(sval,'na_a'//c2,spm10,istatus)
            if( istatus==0 ) then
              ual= w1*spm10(j1)+w2*spm10(j2)+ & 
                   w3*spm10(j3)+w4*spm10(j4)+ &
                   w5*spm10(j5)+w6*spm10(j6)+ &
        ...
        if( l_do_adjoint ) then
          ...
          if( n_cvmas/=0 ) then
            do ksiz=kss, nsize_mosaic_wrf
              write(c2,'(i2.2)') ksiz
              call gsi_bundlegetpointer(rval,'mas_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
          ...
          if( n_cvaer/=0 ) then
            do ksiz=kss, nsize_mosaic_wrf
              write(c2,'(i2.2)') ksiz
              call gsi_bundlegetpointer(rval,'so4_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'no3_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'nh4_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'oc_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'bc_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'oin_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'cl_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
              ...
              call gsi_bundlegetpointer(rval,'na_a'//c2,rpm10,istatus)
              if( istatus==0 ) then
                rpm10(j1)=rpm10(j1)+w1*grad
                rpm10(j2)=rpm10(j2)+w2*grad
                rpm10(j3)=rpm10(j3)+w3*grad
