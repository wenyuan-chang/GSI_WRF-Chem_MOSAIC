...
!!! ================================================================ netcdf
  ...
  !$$$
    ...
    use guess_grids, only: &
         ...
         isli,nfldsig,ifilesig,ges_tsen,sfc_rough,ntguessig       , &
    !!! cwy mosaic --------------------------------------------- chem
    wt_so4_a01, wt_so4_a02, wt_so4_a03, wt_so4_a04, &
    wt_no3_a01, wt_no3_a02, wt_no3_a03, wt_no3_a04, &
    wt_nh4_a01, wt_nh4_a02, wt_nh4_a03, wt_nh4_a04, &
    wt_ocx_a01, wt_ocx_a02, wt_ocx_a03, wt_ocx_a04, &
    wt_bcx_a01, wt_bcx_a02, wt_bcx_a03, wt_bcx_a04, &
    wt_clx_a01, wt_clx_a02, wt_clx_a03, wt_clx_a04, &
    wt_nax_a01, wt_nax_a02, wt_nax_a03, wt_nax_a04, &
    wt_oin_a01, wt_oin_a02, wt_oin_a03, wt_oin_a04, &
    wt_num_a01, wt_num_a02, wt_num_a03, wt_num_a04, &

    wt_so4_a05, wt_so4_a06, wt_so4_a07, wt_so4_a08, &
    wt_no3_a05, wt_no3_a06, wt_no3_a07, wt_no3_a08, &
    wt_nh4_a05, wt_nh4_a06, wt_nh4_a07, wt_nh4_a08, &
    wt_ocx_a05, wt_ocx_a06, wt_ocx_a07, wt_ocx_a08, &
    wt_bcx_a05, wt_bcx_a06, wt_bcx_a07, wt_bcx_a08, &
    wt_clx_a05, wt_clx_a06, wt_clx_a07, wt_clx_a08, &
    wt_nax_a05, wt_nax_a06, wt_nax_a07, wt_nax_a08, &
    wt_oin_a05, wt_oin_a06, wt_oin_a07, wt_oin_a08, &
    wt_num_a05, wt_num_a06, wt_num_a07, wt_num_a08

    use obsmod, only: nsize_mosaic_wrf, rmin_value, n_cvmas, n_cvnum, n_cvaer
    !!! cwy mosaic --------------------------------------------- chem end
  ...
  ! other internal variables
    ...
    !!! cwy mosaic --------------------------------------------- chem
    real(r_single) :: ges_mas_a0x

    integer(i_kind) n_mosaic_var
    integer(i_kind) :: indx_so4_a01, indx_so4_a02, indx_so4_a03, indx_so4_a04
    integer(i_kind) :: indx_no3_a01, indx_no3_a02, indx_no3_a03, indx_no3_a04
    integer(i_kind) :: indx_nh4_a01, indx_nh4_a02, indx_nh4_a03, indx_nh4_a04
    integer(i_kind) :: indx_ocx_a01, indx_ocx_a02, indx_ocx_a03, indx_ocx_a04
    integer(i_kind) :: indx_bcx_a01, indx_bcx_a02, indx_bcx_a03, indx_bcx_a04
    integer(i_kind) :: indx_clx_a01, indx_clx_a02, indx_clx_a03, indx_clx_a04
    integer(i_kind) :: indx_nax_a01, indx_nax_a02, indx_nax_a03, indx_nax_a04
    integer(i_kind) :: indx_oin_a01, indx_oin_a02, indx_oin_a03, indx_oin_a04
    integer(i_kind) :: indx_num_a01, indx_num_a02, indx_num_a03, indx_num_a04
    integer(i_kind) :: indx_h2o_a01, indx_h2o_a02, indx_h2o_a03, indx_h2o_a04
    integer(i_kind) :: indx_mas_a01, indx_mas_a02, indx_mas_a03, indx_mas_a04

    integer(i_kind) :: indx_so4_a05, indx_so4_a06, indx_so4_a07, indx_so4_a08
    integer(i_kind) :: indx_no3_a05, indx_no3_a06, indx_no3_a07, indx_no3_a08
    integer(i_kind) :: indx_nh4_a05, indx_nh4_a06, indx_nh4_a07, indx_nh4_a08
    integer(i_kind) :: indx_ocx_a05, indx_ocx_a06, indx_ocx_a07, indx_ocx_a08
    integer(i_kind) :: indx_bcx_a05, indx_bcx_a06, indx_bcx_a07, indx_bcx_a08
    integer(i_kind) :: indx_clx_a05, indx_clx_a06, indx_clx_a07, indx_clx_a08
    integer(i_kind) :: indx_nax_a05, indx_nax_a06, indx_nax_a07, indx_nax_a08
    integer(i_kind) :: indx_oin_a05, indx_oin_a06, indx_oin_a07, indx_oin_a08
    integer(i_kind) :: indx_num_a05, indx_num_a06, indx_num_a07, indx_num_a08
    integer(i_kind) :: indx_h2o_a05, indx_h2o_a06, indx_h2o_a07, indx_h2o_a08
    integer(i_kind) :: indx_mas_a05, indx_mas_a06, indx_mas_a07, indx_mas_a08

    character(len=20),allocatable :: cvar(:)
    ...
    !!! cwy mosaic --------------------------------------------- chem
    real(r_kind), pointer :: ges_so4_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_so4_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_no3_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_no3_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_nh4_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nh4_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_ocx_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_ocx_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_bcx_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_bcx_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_clx_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_clx_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_nax_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_nax_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_oin_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_oin_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_num_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_num_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_h2o_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_h2o_a08(:,:,:)=>NULL()

    real(r_kind), pointer :: ges_mas_a01(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a02(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a03(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a04(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a05(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a06(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a07(:,:,:)=>NULL()
    real(r_kind), pointer :: ges_mas_a08(:,:,:)=>NULL()
    !!! cwy mosaic --------------------------------------------- chem end
...
!    The 9 3D cloud analysis fields are: ql,qi,qr,qs,qg,qnr,qni,qnc,tt
      ...
      !!! cwy mosaic ----------------------------------- chem
      if( laeroana_mosaic .and. wrf_pm2_5 )then
          if(mype==0) write(6,*)'laeroana_mosaic cannot be both true'
          call stop2(2)
      end if

      if ( laeroana_mosaic ) then
          call gsi_chemguess_get ('aerosols::3d',n_mosaic_var,istatus)
          if ( n_mosaic_var > 0 ) then
             num_mass_fields = num_mass_fields + n_mosaic_var*lm      !!!
          else
             laeroana_mosaic = .false.
          endif
      endif
      !!! cwy mosaic ----------------------------------- chem end
  ...
  ! for cloud array
       ...
       if ( laeroana_mosaic ) then
          if ( n_mosaic_var>0 ) then
             allocate(cvar(n_mosaic_var))
             call gsi_chemguess_get ('aerosols::3d',cvar,ier)
             allocate(i_chem(n_mosaic_var))
             allocate(kchem(n_mosaic_var))
             do iv = 1, n_mosaic_var
                i_chem(iv)=i+1
                do k=1,lm
                  i=i+1
                  jsig_skip(i)=0 ; igtype(i)=1
  ...
  !    mpi_all_to_allv
       ...
       icount_prev=1
       do it=1,nfldsig
          write(filename,'("sigf",i2.2)')ifilesig(it)       !!! read sigf03
          open(lendian_in,file=filename,form='unformatted') ; rewind lendian_in
  ...
  !          Get pointer for each of the hydrometeors from guess at time index "it"
          ...
          if ( laeroana_mosaic ) then
             ...
             if (aero_ratios .and. it==1) call init_aerotot_guess()
             ier = 0
             indx_so4_a01=-1; indx_so4_a02=-1; indx_so4_a03=-1; indx_so4_a04=-1
             indx_no3_a01=-1; indx_no3_a02=-1; indx_no3_a03=-1; indx_no3_a04=-1
             indx_nh4_a01=-1; indx_nh4_a02=-1; indx_nh4_a03=-1; indx_nh4_a04=-1
             indx_ocx_a01=-1; indx_ocx_a02=-1; indx_ocx_a03=-1; indx_ocx_a04=-1
             indx_bcx_a01=-1; indx_bcx_a02=-1; indx_bcx_a03=-1; indx_bcx_a04=-1
             indx_clx_a01=-1; indx_clx_a02=-1; indx_clx_a03=-1; indx_clx_a04=-1
             indx_nax_a01=-1; indx_nax_a02=-1; indx_nax_a03=-1; indx_nax_a04=-1
             indx_oin_a01=-1; indx_oin_a02=-1; indx_oin_a03=-1; indx_oin_a04=-1
             indx_num_a01=-1; indx_num_a02=-1; indx_num_a03=-1; indx_num_a04=-1
             indx_h2o_a01=-1; indx_h2o_a02=-1; indx_h2o_a03=-1; indx_h2o_a04=-1
             indx_mas_a01=-1; indx_mas_a02=-1; indx_mas_a03=-1; indx_mas_a04=-1

             indx_so4_a05=-1; indx_so4_a06=-1; indx_so4_a07=-1; indx_so4_a08=-1
             indx_no3_a05=-1; indx_no3_a06=-1; indx_no3_a07=-1; indx_no3_a08=-1
             indx_nh4_a05=-1; indx_nh4_a06=-1; indx_nh4_a07=-1; indx_nh4_a08=-1
             indx_ocx_a05=-1; indx_ocx_a06=-1; indx_ocx_a07=-1; indx_ocx_a08=-1
             indx_bcx_a05=-1; indx_bcx_a06=-1; indx_bcx_a07=-1; indx_bcx_a08=-1
             indx_clx_a05=-1; indx_clx_a06=-1; indx_clx_a07=-1; indx_clx_a08=-1
             indx_nax_a05=-1; indx_nax_a06=-1; indx_nax_a07=-1; indx_nax_a08=-1
             indx_oin_a05=-1; indx_oin_a06=-1; indx_oin_a07=-1; indx_oin_a08=-1
             indx_num_a05=-1; indx_num_a06=-1; indx_num_a07=-1; indx_num_a08=-1
             indx_h2o_a05=-1; indx_h2o_a06=-1; indx_h2o_a07=-1; indx_h2o_a08=-1
             indx_mas_a05=-1; indx_mas_a06=-1; indx_mas_a07=-1; indx_mas_a08=-1

             do iv = 1, n_mosaic_var
                if ( ier == 0 ) then
                   select case ( trim(cvar(iv)) )
                   case ( 'so4_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a01,istatus);ier=ier+istatus
                      indx_so4_a01 = iv
                   case ( 'so4_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a02,istatus);ier=ier+istatus
                      indx_so4_a02 = iv
                   case ( 'so4_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a03,istatus);ier=ier+istatus
                      indx_so4_a03 = iv
                   case ( 'so4_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a04,istatus);ier=ier+istatus
                      indx_so4_a04 = iv
                   case ( 'so4_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a05,istatus);ier=ier+istatus
                      indx_so4_a05 = iv
                   case ( 'so4_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a06,istatus);ier=ier+istatus
                      indx_so4_a06 = iv
                   case ( 'so4_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a07,istatus);ier=ier+istatus
                      indx_so4_a07 = iv
                   case ( 'so4_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_so4_a08,istatus);ier=ier+istatus
                      indx_so4_a08 = iv

                   case ( 'no3_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a01,istatus);ier=ier+istatus
                      indx_no3_a01 = iv
                   case ( 'no3_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a02,istatus);ier=ier+istatus
                      indx_no3_a02 = iv
                   case ( 'no3_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a03,istatus);ier=ier+istatus
                      indx_no3_a03 = iv
                   case ( 'no3_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a04,istatus);ier=ier+istatus
                      indx_no3_a04 = iv
                   case ( 'no3_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a05,istatus);ier=ier+istatus
                      indx_no3_a05 = iv
                   case ( 'no3_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a06,istatus);ier=ier+istatus
                      indx_no3_a06 = iv
                   case ( 'no3_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a07,istatus);ier=ier+istatus
                      indx_no3_a07 = iv
                   case ( 'no3_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_no3_a08,istatus);ier=ier+istatus
                      indx_no3_a08 = iv

                   case ( 'nh4_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a01,istatus);ier=ier+istatus
                      indx_nh4_a01 = iv
                   case ( 'nh4_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a02,istatus);ier=ier+istatus
                      indx_nh4_a02 = iv
                   case ( 'nh4_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a03,istatus);ier=ier+istatus
                      indx_nh4_a03 = iv
                   case ( 'nh4_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a04,istatus);ier=ier+istatus
                      indx_nh4_a04 = iv
                   case ( 'nh4_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a05,istatus);ier=ier+istatus
                      indx_nh4_a05 = iv
                   case ( 'nh4_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a06,istatus);ier=ier+istatus
                      indx_nh4_a06 = iv
                   case ( 'nh4_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a07,istatus);ier=ier+istatus
                      indx_nh4_a07 = iv
                   case ( 'nh4_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nh4_a08,istatus);ier=ier+istatus
                      indx_nh4_a08 = iv

                   case ( 'oc_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a01,istatus);ier=ier+istatus
                      indx_ocx_a01 = iv
                   case ( 'oc_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a02,istatus);ier=ier+istatus
                      indx_ocx_a02 = iv
                   case ( 'oc_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a03,istatus);ier=ier+istatus
                      indx_ocx_a03 = iv
                   case ( 'oc_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a04,istatus);ier=ier+istatus
                      indx_ocx_a04 = iv
                   case ( 'oc_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a05,istatus);ier=ier+istatus
                      indx_ocx_a05 = iv
                   case ( 'oc_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a06,istatus);ier=ier+istatus
                      indx_ocx_a06 = iv
                   case ( 'oc_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a07,istatus);ier=ier+istatus
                      indx_ocx_a07 = iv
                   case ( 'oc_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_ocx_a08,istatus);ier=ier+istatus
                      indx_ocx_a08 = iv

                   case ( 'bc_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a01,istatus);ier=ier+istatus
                      indx_bcx_a01 = iv
                   case ( 'bc_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a02,istatus);ier=ier+istatus
                      indx_bcx_a02 = iv
                   case ( 'bc_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a03,istatus);ier=ier+istatus
                      indx_bcx_a03 = iv
                   case ( 'bc_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a04,istatus);ier=ier+istatus
                      indx_bcx_a04 = iv
                   case ( 'bc_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a05,istatus);ier=ier+istatus
                      indx_bcx_a05 = iv
                   case ( 'bc_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a06,istatus);ier=ier+istatus
                      indx_bcx_a06 = iv
                   case ( 'bc_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a07,istatus);ier=ier+istatus
                      indx_bcx_a07 = iv
                   case ( 'bc_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_bcx_a08,istatus);ier=ier+istatus
                      indx_bcx_a08 = iv

                   case ( 'cl_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a01,istatus);ier=ier+istatus
                      indx_clx_a01 = iv
                   case ( 'cl_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a02,istatus);ier=ier+istatus
                      indx_clx_a02 = iv
                   case ( 'cl_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a03,istatus);ier=ier+istatus
                      indx_clx_a03 = iv
                   case ( 'cl_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a04,istatus);ier=ier+istatus
                      indx_clx_a04 = iv
                   case ( 'cl_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a05,istatus);ier=ier+istatus
                      indx_clx_a05 = iv
                   case ( 'cl_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a06,istatus);ier=ier+istatus
                      indx_clx_a06 = iv
                   case ( 'cl_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a07,istatus);ier=ier+istatus
                      indx_clx_a07 = iv
                   case ( 'cl_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_clx_a08,istatus);ier=ier+istatus
                      indx_clx_a08 = iv

                   case ( 'na_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a01,istatus);ier=ier+istatus
                      indx_nax_a01 = iv
                   case ( 'na_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a02,istatus);ier=ier+istatus
                      indx_nax_a02 = iv
                   case ( 'na_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a03,istatus);ier=ier+istatus
                      indx_nax_a03 = iv
                   case ( 'na_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a04,istatus);ier=ier+istatus
                      indx_nax_a04 = iv
                   case ( 'na_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a05,istatus);ier=ier+istatus
                      indx_nax_a05 = iv
                   case ( 'na_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a06,istatus);ier=ier+istatus
                      indx_nax_a06 = iv
                   case ( 'na_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a07,istatus);ier=ier+istatus
                      indx_nax_a07 = iv
                   case ( 'na_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_nax_a08,istatus);ier=ier+istatus
                      indx_nax_a08 = iv

                   case ( 'oin_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a01,istatus);ier=ier+istatus
                      indx_oin_a01 = iv
                   case ( 'oin_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a02,istatus);ier=ier+istatus
                      indx_oin_a02 = iv
                   case ( 'oin_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a03,istatus);ier=ier+istatus
                      indx_oin_a03 = iv
                   case ( 'oin_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a04,istatus);ier=ier+istatus
                      indx_oin_a04 = iv
                   case ( 'oin_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a05,istatus);ier=ier+istatus
                      indx_oin_a05 = iv
                   case ( 'oin_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a06,istatus);ier=ier+istatus
                      indx_oin_a06 = iv
                   case ( 'oin_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a07,istatus);ier=ier+istatus
                      indx_oin_a07 = iv
                   case ( 'oin_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_oin_a08,istatus);ier=ier+istatus
                      indx_oin_a08 = iv

                   case ( 'num_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a01,istatus);ier=ier+istatus
                      indx_num_a01 = iv
                   case ( 'num_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a02,istatus);ier=ier+istatus
                      indx_num_a02 = iv
                   case ( 'num_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a03,istatus);ier=ier+istatus
                      indx_num_a03 = iv
                   case ( 'num_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a04,istatus);ier=ier+istatus
                      indx_num_a04 = iv
                   case ( 'num_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a05,istatus);ier=ier+istatus
                      indx_num_a05 = iv
                   case ( 'num_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a06,istatus);ier=ier+istatus
                      indx_num_a06 = iv
                   case ( 'num_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a07,istatus);ier=ier+istatus
                      indx_num_a07 = iv
                   case ( 'num_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_num_a08,istatus);ier=ier+istatus
                      indx_num_a08 = iv

                   case ( 'water_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a01,istatus);ier=ier+istatus
                      indx_h2o_a01 = iv
                   case ( 'water_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a02,istatus);ier=ier+istatus
                      indx_h2o_a02 = iv
                   case ( 'water_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a03,istatus);ier=ier+istatus
                      indx_h2o_a03 = iv
                   case ( 'water_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a04,istatus);ier=ier+istatus
                      indx_h2o_a04 = iv
                   case ( 'water_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a05,istatus);ier=ier+istatus
                      indx_h2o_a05 = iv
                   case ( 'water_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a06,istatus);ier=ier+istatus
                      indx_h2o_a06 = iv
                   case ( 'water_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a07,istatus);ier=ier+istatus
                      indx_h2o_a07 = iv
                   case ( 'water_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_h2o_a08,istatus);ier=ier+istatus
                      indx_h2o_a08 = iv

                   case ( 'mas_a01' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a01,istatus);ier=ier+istatus
                      indx_mas_a01 = iv
                   case ( 'mas_a02' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a02,istatus);ier=ier+istatus
                      indx_mas_a02 = iv
                   case ( 'mas_a03' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a03,istatus);ier=ier+istatus
                      indx_mas_a03 = iv
                   case ( 'mas_a04' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a04,istatus);ier=ier+istatus
                      indx_mas_a04 = iv
                   case ( 'mas_a05' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a05,istatus);ier=ier+istatus
                      indx_mas_a05 = iv
                   case ( 'mas_a06' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a06,istatus);ier=ier+istatus
                      indx_mas_a06 = iv
                   case ( 'mas_a07' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a07,istatus);ier=ier+istatus
                      indx_mas_a07 = iv
                   case ( 'mas_a08' )
                      call GSI_BundleGetPointer(GSI_ChemGuess_Bundle(it),cvar(iv),ges_mas_a08,istatus);ier=ier+istatus
                      indx_mas_a08 = iv
                   end select
                endif
                if (ier/=0 .and. mype == 0) then
  ...
  !                    ges_tten(j,i,k,it) = real(all_loc(j,i,ktt),r_kind)
                   ...
                   !!! cwy mosaic --------------------------------------------------------------- chem
                   if ( laeroana_mosaic ) then
                      if (indx_so4_a01>0)  ges_so4_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a01)),r_kind)
                      if (indx_so4_a02>0)  ges_so4_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a02)),r_kind)
                      if (indx_so4_a03>0)  ges_so4_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a03)),r_kind)
                      if (indx_so4_a04>0)  ges_so4_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a04)),r_kind)
                      if (indx_so4_a05>0)  ges_so4_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a05)),r_kind)
                      if (indx_so4_a06>0)  ges_so4_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a06)),r_kind)
                      if (indx_so4_a07>0)  ges_so4_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a07)),r_kind)
                      if (indx_so4_a08>0)  ges_so4_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_so4_a08)),r_kind)

                      if (indx_no3_a01>0)  ges_no3_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a01)),r_kind)
                      if (indx_no3_a02>0)  ges_no3_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a02)),r_kind)
                      if (indx_no3_a03>0)  ges_no3_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a03)),r_kind)
                      if (indx_no3_a04>0)  ges_no3_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a04)),r_kind)
                      if (indx_no3_a05>0)  ges_no3_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a05)),r_kind)
                      if (indx_no3_a06>0)  ges_no3_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a06)),r_kind)
                      if (indx_no3_a07>0)  ges_no3_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a07)),r_kind)
                      if (indx_no3_a08>0)  ges_no3_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_no3_a08)),r_kind)

                      if (indx_nh4_a01>0)  ges_nh4_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a01)),r_kind)
                      if (indx_nh4_a02>0)  ges_nh4_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a02)),r_kind)
                      if (indx_nh4_a03>0)  ges_nh4_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a03)),r_kind)
                      if (indx_nh4_a04>0)  ges_nh4_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a04)),r_kind)
                      if (indx_nh4_a05>0)  ges_nh4_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a05)),r_kind)
                      if (indx_nh4_a06>0)  ges_nh4_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a06)),r_kind)
                      if (indx_nh4_a07>0)  ges_nh4_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a07)),r_kind)
                      if (indx_nh4_a08>0)  ges_nh4_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_nh4_a08)),r_kind)

                      if (indx_ocx_a01>0)  ges_ocx_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a01)),r_kind)
                      if (indx_ocx_a02>0)  ges_ocx_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a02)),r_kind)
                      if (indx_ocx_a03>0)  ges_ocx_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a03)),r_kind)
                      if (indx_ocx_a04>0)  ges_ocx_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a04)),r_kind)
                      if (indx_ocx_a05>0)  ges_ocx_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a05)),r_kind)
                      if (indx_ocx_a06>0)  ges_ocx_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a06)),r_kind)
                      if (indx_ocx_a07>0)  ges_ocx_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a07)),r_kind)
                      if (indx_ocx_a08>0)  ges_ocx_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_ocx_a08)),r_kind)

                      if (indx_bcx_a01>0)  ges_bcx_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a01)),r_kind)
                      if (indx_bcx_a02>0)  ges_bcx_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a02)),r_kind)
                      if (indx_bcx_a03>0)  ges_bcx_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a03)),r_kind)
                      if (indx_bcx_a04>0)  ges_bcx_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a04)),r_kind)
                      if (indx_bcx_a05>0)  ges_bcx_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a05)),r_kind)
                      if (indx_bcx_a06>0)  ges_bcx_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a06)),r_kind)
                      if (indx_bcx_a07>0)  ges_bcx_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a07)),r_kind)
                      if (indx_bcx_a08>0)  ges_bcx_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_bcx_a08)),r_kind)

                      if (indx_clx_a01>0)  ges_clx_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a01)),r_kind)
                      if (indx_clx_a02>0)  ges_clx_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a02)),r_kind)
                      if (indx_clx_a03>0)  ges_clx_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a03)),r_kind)
                      if (indx_clx_a04>0)  ges_clx_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a04)),r_kind)
                      if (indx_clx_a05>0)  ges_clx_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a05)),r_kind)
                      if (indx_clx_a06>0)  ges_clx_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a06)),r_kind)
                      if (indx_clx_a07>0)  ges_clx_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a07)),r_kind)
                      if (indx_clx_a08>0)  ges_clx_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_clx_a08)),r_kind)

                      if (indx_nax_a01>0)  ges_nax_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a01)),r_kind)
                      if (indx_nax_a02>0)  ges_nax_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a02)),r_kind)
                      if (indx_nax_a03>0)  ges_nax_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a03)),r_kind)
                      if (indx_nax_a04>0)  ges_nax_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a04)),r_kind)
                      if (indx_nax_a05>0)  ges_nax_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a05)),r_kind)
                      if (indx_nax_a06>0)  ges_nax_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a06)),r_kind)
                      if (indx_nax_a07>0)  ges_nax_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a07)),r_kind)
                      if (indx_nax_a08>0)  ges_nax_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_nax_a08)),r_kind)

                      if (indx_oin_a01>0)  ges_oin_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a01)),r_kind)
                      if (indx_oin_a02>0)  ges_oin_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a02)),r_kind)
                      if (indx_oin_a03>0)  ges_oin_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a03)),r_kind)
                      if (indx_oin_a04>0)  ges_oin_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a04)),r_kind)
                      if (indx_oin_a05>0)  ges_oin_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a05)),r_kind)
                      if (indx_oin_a06>0)  ges_oin_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a06)),r_kind)
                      if (indx_oin_a07>0)  ges_oin_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a07)),r_kind)
                      if (indx_oin_a08>0)  ges_oin_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_oin_a08)),r_kind)

                      if (indx_num_a01>0)  ges_num_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a01)),r_kind)
                      if (indx_num_a02>0)  ges_num_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a02)),r_kind)
                      if (indx_num_a03>0)  ges_num_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a03)),r_kind)
                      if (indx_num_a04>0)  ges_num_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a04)),r_kind)
                      if (indx_num_a05>0)  ges_num_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a05)),r_kind)
                      if (indx_num_a06>0)  ges_num_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a06)),r_kind)
                      if (indx_num_a07>0)  ges_num_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a07)),r_kind)
                      if (indx_num_a08>0)  ges_num_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_num_a08)),r_kind)

                      if (indx_h2o_a01>0)  ges_h2o_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a01)),r_kind)
                      if (indx_h2o_a02>0)  ges_h2o_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a02)),r_kind)
                      if (indx_h2o_a03>0)  ges_h2o_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a03)),r_kind)
                      if (indx_h2o_a04>0)  ges_h2o_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a04)),r_kind)
                      if (indx_h2o_a05>0)  ges_h2o_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a05)),r_kind)
                      if (indx_h2o_a06>0)  ges_h2o_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a06)),r_kind)
                      if (indx_h2o_a07>0)  ges_h2o_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a07)),r_kind)
                      if (indx_h2o_a08>0)  ges_h2o_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_h2o_a08)),r_kind)

                      if (indx_mas_a01>0)  ges_mas_a01(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a01)),r_kind)
                      if (indx_mas_a02>0)  ges_mas_a02(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a02)),r_kind)
                      if (indx_mas_a03>0)  ges_mas_a03(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a03)),r_kind)
                      if (indx_mas_a04>0)  ges_mas_a04(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a04)),r_kind)
                      if (indx_mas_a05>0)  ges_mas_a05(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a05)),r_kind)
                      if (indx_mas_a06>0)  ges_mas_a06(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a06)),r_kind)
                      if (indx_mas_a07>0)  ges_mas_a07(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a07)),r_kind)
                      if (indx_mas_a08>0)  ges_mas_a08(j,i,k)  = real(all_loc(j,i,kchem(indx_mas_a08)),r_kind)

                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_so4_a01(j,i,k)=ges_so4_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_no3_a01(j,i,k)=ges_no3_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_nh4_a01(j,i,k)=ges_nh4_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_ocx_a01(j,i,k)=ges_ocx_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_bcx_a01(j,i,k)=ges_bcx_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_clx_a01(j,i,k)=ges_clx_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_nax_a01(j,i,k)=ges_nax_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_oin_a01(j,i,k)=ges_oin_a01(j,i,k)/ges_mas_a01(j,i,k)
                      if( ges_mas_a01(j,i,k)>rmin_value ) wt_num_a01(j,i,k)=ges_num_a01(j,i,k)/ges_mas_a01(j,i,k)

                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_so4_a02(j,i,k)=ges_so4_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_no3_a02(j,i,k)=ges_no3_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_nh4_a02(j,i,k)=ges_nh4_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_ocx_a02(j,i,k)=ges_ocx_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_bcx_a02(j,i,k)=ges_bcx_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_clx_a02(j,i,k)=ges_clx_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_nax_a02(j,i,k)=ges_nax_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_oin_a02(j,i,k)=ges_oin_a02(j,i,k)/ges_mas_a02(j,i,k)
                      if( ges_mas_a02(j,i,k)>rmin_value ) wt_num_a02(j,i,k)=ges_num_a02(j,i,k)/ges_mas_a02(j,i,k)

                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_so4_a03(j,i,k)=ges_so4_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_no3_a03(j,i,k)=ges_no3_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_nh4_a03(j,i,k)=ges_nh4_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_ocx_a03(j,i,k)=ges_ocx_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_bcx_a03(j,i,k)=ges_bcx_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_clx_a03(j,i,k)=ges_clx_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_nax_a03(j,i,k)=ges_nax_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_oin_a03(j,i,k)=ges_oin_a03(j,i,k)/ges_mas_a03(j,i,k)
                      if( ges_mas_a03(j,i,k)>rmin_value ) wt_num_a03(j,i,k)=ges_num_a03(j,i,k)/ges_mas_a03(j,i,k)

                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_so4_a04(j,i,k)=ges_so4_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_no3_a04(j,i,k)=ges_no3_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_nh4_a04(j,i,k)=ges_nh4_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_ocx_a04(j,i,k)=ges_ocx_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_bcx_a04(j,i,k)=ges_bcx_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_clx_a04(j,i,k)=ges_clx_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_nax_a04(j,i,k)=ges_nax_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_oin_a04(j,i,k)=ges_oin_a04(j,i,k)/ges_mas_a04(j,i,k)
                      if( ges_mas_a04(j,i,k)>rmin_value ) wt_num_a04(j,i,k)=ges_num_a04(j,i,k)/ges_mas_a04(j,i,k)

                      if( nsize_mosaic_wrf==8 ) then
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_so4_a05(j,i,k)=ges_so4_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_no3_a05(j,i,k)=ges_no3_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_nh4_a05(j,i,k)=ges_nh4_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_ocx_a05(j,i,k)=ges_ocx_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_bcx_a05(j,i,k)=ges_bcx_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_clx_a05(j,i,k)=ges_clx_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_nax_a05(j,i,k)=ges_nax_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_oin_a05(j,i,k)=ges_oin_a05(j,i,k)/ges_mas_a05(j,i,k)
                      if( ges_mas_a05(j,i,k)>rmin_value ) wt_num_a05(j,i,k)=ges_num_a05(j,i,k)/ges_mas_a05(j,i,k)

                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_so4_a06(j,i,k)=ges_so4_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_no3_a06(j,i,k)=ges_no3_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_nh4_a06(j,i,k)=ges_nh4_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_ocx_a06(j,i,k)=ges_ocx_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_bcx_a06(j,i,k)=ges_bcx_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_clx_a06(j,i,k)=ges_clx_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_nax_a06(j,i,k)=ges_nax_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_oin_a06(j,i,k)=ges_oin_a06(j,i,k)/ges_mas_a06(j,i,k)
                      if( ges_mas_a06(j,i,k)>rmin_value ) wt_num_a06(j,i,k)=ges_num_a06(j,i,k)/ges_mas_a06(j,i,k)

                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_so4_a07(j,i,k)=ges_so4_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_no3_a07(j,i,k)=ges_no3_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_nh4_a07(j,i,k)=ges_nh4_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_ocx_a07(j,i,k)=ges_ocx_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_bcx_a07(j,i,k)=ges_bcx_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_clx_a07(j,i,k)=ges_clx_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_nax_a07(j,i,k)=ges_nax_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_oin_a07(j,i,k)=ges_oin_a07(j,i,k)/ges_mas_a07(j,i,k)
                      if( ges_mas_a07(j,i,k)>rmin_value ) wt_num_a07(j,i,k)=ges_num_a07(j,i,k)/ges_mas_a07(j,i,k)

                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_so4_a08(j,i,k)=ges_so4_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_no3_a08(j,i,k)=ges_no3_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_nh4_a08(j,i,k)=ges_nh4_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_ocx_a08(j,i,k)=ges_ocx_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_bcx_a08(j,i,k)=ges_bcx_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_clx_a08(j,i,k)=ges_clx_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_nax_a08(j,i,k)=ges_nax_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_oin_a08(j,i,k)=ges_oin_a08(j,i,k)/ges_mas_a08(j,i,k)
                      if( ges_mas_a08(j,i,k)>rmin_value ) wt_num_a08(j,i,k)=ges_num_a08(j,i,k)/ges_mas_a08(j,i,k)
                      end if
                   end if
                   !!! cwy mosaic --------------------------------------------------------------- chem end
                end do
