...
!$$$
  ...
  !!! out: al, actual recursive filter "alpha" coef
  !!! vx: effective grid step in covariance-scale units
  ...
  !!! vertical smoothing for renormalization, out: p1
