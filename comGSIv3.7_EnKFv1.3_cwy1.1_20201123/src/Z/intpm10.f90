...
!!!    if (wrf_mass_regional) then
    if (wrf_mass_regional .and. .not.laeroana_mosaic4) then
!!! cwy mosaic4 -------------------------------------- chem
...
!!! cwy mosaic4 -------------------------------------- chem
    if (wrf_mass_regional .and. laeroana_mosaic4) then
      ...
      do while( associated(pm10ptr) )
        ...
        call gsi_bundlegetpointer(sval,trim(aeroname),spm10,istatus)
        if( istatus/=0 ) then
          write(6,*) 'error gsi_bundlegetpointer for '//aeroname
          call stop2(454)
        end if
        ual= w1*spm10(j1)+w2*spm10(j2)+ &
             w3*spm10(j3)+w4*spm10(j4)+ &
             w5*spm10(j5)+w6*spm10(j6)+ &
             w7*spm10(j7)+w8*spm10(j8)
        val=ual*pm10ptr%dpmx_dnum(1)
        nullify(spm10)
        ...
        ual= w1*spm10(j1)+w2*spm10(j2)+ &
             ...
             w5*spm10(j5)+w6*spm10(j6)+ &
             w7*spm10(j7)+w8*spm10(j8)
        val=ual*pm10ptr%dpmx_dnum(2)+ val
        nullify(spm10)
        ...
        ual= w1*spm10(j1)+w2*spm10(j2)+ &
             ...
             w5*spm10(j5)+w6*spm10(j6)+ &
             w7*spm10(j7)+w8*spm10(j8)
        val=ual*pm10ptr%dpmx_dnum(3)+ val
        nullify(spm10)
        ...
        ual= w1*spm10(j1)+w2*spm10(j2)+ &
             ...
             w5*spm10(j5)+w6*spm10(j6)+ &
             w7*spm10(j7)+w8*spm10(j8)
        val=ual*pm10ptr%dpmx_dnum(4)+ val
        nullify(spm10)
        ...
        if( l_do_adjoint ) then
          ...
          rpm10(j1)=rpm10(j1)+w1*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j2)=rpm10(j2)+w2*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j3)=rpm10(j3)+w3*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j4)=rpm10(j4)+w4*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j5)=rpm10(j5)+w5*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j6)=rpm10(j6)+w6*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j7)=rpm10(j7)+w7*grad*pm10ptr%dpmx_dnum(1)
          rpm10(j8)=rpm10(j8)+w8*grad*pm10ptr%dpmx_dnum(1)
          nullify(rpm10)
          ...
          rpm10(j1)=rpm10(j1)+w1*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j2)=rpm10(j2)+w2*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j3)=rpm10(j3)+w3*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j4)=rpm10(j4)+w4*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j5)=rpm10(j5)+w5*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j6)=rpm10(j6)+w6*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j7)=rpm10(j7)+w7*grad*pm10ptr%dpmx_dnum(2)
          rpm10(j8)=rpm10(j8)+w8*grad*pm10ptr%dpmx_dnum(2)
          nullify(rpm10)
          ...
          rpm10(j1)=rpm10(j1)+w1*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j2)=rpm10(j2)+w2*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j3)=rpm10(j3)+w3*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j4)=rpm10(j4)+w4*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j5)=rpm10(j5)+w5*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j6)=rpm10(j6)+w6*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j7)=rpm10(j7)+w7*grad*pm10ptr%dpmx_dnum(3)
          rpm10(j8)=rpm10(j8)+w8*grad*pm10ptr%dpmx_dnum(3)
          nullify(rpm10)
          ...
          rpm10(j1)=rpm10(j1)+w1*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j2)=rpm10(j2)+w2*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j3)=rpm10(j3)+w3*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j4)=rpm10(j4)+w4*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j5)=rpm10(j5)+w5*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j6)=rpm10(j6)+w6*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j7)=rpm10(j7)+w7*grad*pm10ptr%dpmx_dnum(4)
          rpm10(j8)=rpm10(j8)+w8*grad*pm10ptr%dpmx_dnum(4)
          nullify(rpm10)
