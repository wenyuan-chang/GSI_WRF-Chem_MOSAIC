      ...
      do while( associated(pm10ptr) )
        if( pm10ptr%luse ) then
          if( nstep>0 ) then
            ...
            call gsi_bundlegetpointer(sval,trim(aeroname),spm10,istatus)
            if( istatus/=0 ) then
              write(6,*) 'error gsi_bundlegetpointer in stppm10 for '//aeroname
              call stop2(456)
            end if
            call gsi_bundlegetpointer(rval,trim(aeroname),rpm10,istatus)
            if( istatus/=0 ) then
            ...
            val =(w1*rpm10(j1)+w2*rpm10(j2)+w3*rpm10(j3)+w4*rpm10(j4)+ &
                  w5*rpm10(j5)+w6*rpm10(j6)+w7*rpm10(j7)+w8*rpm10(j8))*&
                  pm10ptr%dpmx_dnum(1)+val
            val2=(w1*spm10(j1)+w2*spm10(j2)+w3*spm10(j3)+w4*spm10(j4)+ &
                  w5*spm10(j5)+w6*spm10(j6)+w7*spm10(j7)+w8*spm10(j8))*&
                  pm10ptr%dpmx_dnum(1)+val2
            nullify(spm10,rpm10)
            ...
            val =(w1*rpm10(j1)+w2*rpm10(j2)+w3*rpm10(j3)+w4*rpm10(j4)+ &
                  w5*rpm10(j5)+w6*rpm10(j6)+w7*rpm10(j7)+w8*rpm10(j8))*&
                  pm10ptr%dpmx_dnum(2)+val
            val2=(w1*spm10(j1)+w2*spm10(j2)+w3*spm10(j3)+w4*spm10(j4)+ &
                  w5*spm10(j5)+w6*spm10(j6)+w7*spm10(j7)+w8*spm10(j8))*&
                  pm10ptr%dpmx_dnum(2)+val2
            nullify(spm10,rpm10)
            ...
            val =(w1*rpm10(j1)+w2*rpm10(j2)+w3*rpm10(j3)+w4*rpm10(j4)+ &
                  w5*rpm10(j5)+w6*rpm10(j6)+w7*rpm10(j7)+w8*rpm10(j8))*&
                  pm10ptr%dpmx_dnum(3)+val
            val2=(w1*spm10(j1)+w2*spm10(j2)+w3*spm10(j3)+w4*spm10(j4)+ &
                  w5*spm10(j5)+w6*spm10(j6)+w7*spm10(j7)+w8*spm10(j8))*&
                  pm10ptr%dpmx_dnum(3)+val2
            nullify(spm10,rpm10)
            ...
            val =(w1*rpm10(j1)+w2*rpm10(j2)+w3*rpm10(j3)+w4*rpm10(j4)+ &
                  w5*rpm10(j5)+w6*rpm10(j6)+w7*rpm10(j7)+w8*rpm10(j8))*&
                  pm10ptr%dpmx_dnum(4)+val
            val2=(w1*spm10(j1)+w2*spm10(j2)+w3*spm10(j3)+w4*spm10(j4)+ &
                  w5*spm10(j5)+w6*spm10(j6)+w7*spm10(j7)+w8*spm10(j8))*&
                  pm10ptr%dpmx_dnum(4)+val2
            nullify(spm10,rpm10)
