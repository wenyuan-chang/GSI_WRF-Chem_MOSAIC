...
!!! cwy mosaic --------------------------------------------------- chem
!  public :: wt_mas_a01, wt_mas_a02, wt_mas_a03, wt_mas_a04
  public :: wt_so4_a01, wt_so4_a02, wt_so4_a03, wt_so4_a04
  public :: wt_no3_a01, wt_no3_a02, wt_no3_a03, wt_no3_a04
  public :: wt_nh4_a01, wt_nh4_a02, wt_nh4_a03, wt_nh4_a04
  public :: wt_ocx_a01, wt_ocx_a02, wt_ocx_a03, wt_ocx_a04
  public :: wt_bcx_a01, wt_bcx_a02, wt_bcx_a03, wt_bcx_a04
  public :: wt_clx_a01, wt_clx_a02, wt_clx_a03, wt_clx_a04
  public :: wt_nax_a01, wt_nax_a02, wt_nax_a03, wt_nax_a04
  public :: wt_oin_a01, wt_oin_a02, wt_oin_a03, wt_oin_a04

  public :: wt_so4_a05, wt_so4_a06, wt_so4_a07, wt_so4_a08
  public :: wt_no3_a05, wt_no3_a06, wt_no3_a07, wt_no3_a08
  public :: wt_nh4_a05, wt_nh4_a06, wt_nh4_a07, wt_nh4_a08
  public :: wt_ocx_a05, wt_ocx_a06, wt_ocx_a07, wt_ocx_a08
  public :: wt_bcx_a05, wt_bcx_a06, wt_bcx_a07, wt_bcx_a08
  public :: wt_clx_a05, wt_clx_a06, wt_clx_a07, wt_clx_a08
  public :: wt_nax_a05, wt_nax_a06, wt_nax_a07, wt_nax_a08
  public :: wt_oin_a05, wt_oin_a06, wt_oin_a07, wt_oin_a08

  public :: wt_num_a01, wt_num_a02, wt_num_a03, wt_num_a04
  public :: wt_num_a05, wt_num_a06, wt_num_a07, wt_num_a08
!!! cwy mosaic --------------------------------------------------- chem
...
!!! cwy mosaic ----------------------------------------------- chem
!  real(r_kind),allocatable,dimension(:,:,:)::wt_mas_a01,wt_mas_a02,wt_mas_a03,wt_mas_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_so4_a01,wt_so4_a02,wt_so4_a03,wt_so4_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_no3_a01,wt_no3_a02,wt_no3_a03,wt_no3_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_nh4_a01,wt_nh4_a02,wt_nh4_a03,wt_nh4_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_ocx_a01,wt_ocx_a02,wt_ocx_a03,wt_ocx_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_bcx_a01,wt_bcx_a02,wt_bcx_a03,wt_bcx_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_clx_a01,wt_clx_a02,wt_clx_a03,wt_clx_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_nax_a01,wt_nax_a02,wt_nax_a03,wt_nax_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_oin_a01,wt_oin_a02,wt_oin_a03,wt_oin_a04

  real(r_kind),allocatable,dimension(:,:,:)::wt_so4_a05,wt_so4_a06,wt_so4_a07,wt_so4_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_no3_a05,wt_no3_a06,wt_no3_a07,wt_no3_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_nh4_a05,wt_nh4_a06,wt_nh4_a07,wt_nh4_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_ocx_a05,wt_ocx_a06,wt_ocx_a07,wt_ocx_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_bcx_a05,wt_bcx_a06,wt_bcx_a07,wt_bcx_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_clx_a05,wt_clx_a06,wt_clx_a07,wt_clx_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_nax_a05,wt_nax_a06,wt_nax_a07,wt_nax_a08
  real(r_kind),allocatable,dimension(:,:,:)::wt_oin_a05,wt_oin_a06,wt_oin_a07,wt_oin_a08

  real(r_kind),allocatable,dimension(:,:,:)::wt_num_a01,wt_num_a02,wt_num_a03,wt_num_a04
  real(r_kind),allocatable,dimension(:,:,:)::wt_num_a05,wt_num_a06,wt_num_a07,wt_num_a08
!!! cwy mosaic ----------------------------------------------- chem
...
!!! cwy mosaic --------------------------------------------- chem
!      allocate( wt_mas_a01(lat2,lon2,nsig), wt_mas_a02(lat2,lon2,nsig) )
!      allocate( wt_mas_a03(lat2,lon2,nsig), wt_mas_a04(lat2,lon2,nsig) )

      allocate( wt_so4_a01(lat2,lon2,nsig), wt_so4_a02(lat2,lon2,nsig) )
      allocate( wt_so4_a03(lat2,lon2,nsig), wt_so4_a04(lat2,lon2,nsig) )

      allocate( wt_no3_a01(lat2,lon2,nsig), wt_no3_a02(lat2,lon2,nsig) )
      allocate( wt_no3_a03(lat2,lon2,nsig), wt_no3_a04(lat2,lon2,nsig) )

      allocate( wt_nh4_a01(lat2,lon2,nsig), wt_nh4_a02(lat2,lon2,nsig) )
      allocate( wt_nh4_a03(lat2,lon2,nsig), wt_nh4_a04(lat2,lon2,nsig) )

      allocate( wt_ocx_a01(lat2,lon2,nsig), wt_ocx_a02(lat2,lon2,nsig) )
      allocate( wt_ocx_a03(lat2,lon2,nsig), wt_ocx_a04(lat2,lon2,nsig) )

      allocate( wt_bcx_a01(lat2,lon2,nsig), wt_bcx_a02(lat2,lon2,nsig) )
      allocate( wt_bcx_a03(lat2,lon2,nsig), wt_bcx_a04(lat2,lon2,nsig) )

      allocate( wt_clx_a01(lat2,lon2,nsig), wt_clx_a02(lat2,lon2,nsig) )
      allocate( wt_clx_a03(lat2,lon2,nsig), wt_clx_a04(lat2,lon2,nsig) )

      allocate( wt_nax_a01(lat2,lon2,nsig), wt_nax_a02(lat2,lon2,nsig) )
      allocate( wt_nax_a03(lat2,lon2,nsig), wt_nax_a04(lat2,lon2,nsig) )

      allocate( wt_oin_a01(lat2,lon2,nsig), wt_oin_a02(lat2,lon2,nsig) )
      allocate( wt_oin_a03(lat2,lon2,nsig), wt_oin_a04(lat2,lon2,nsig) )

      allocate( wt_num_a01(lat2,lon2,nsig), wt_num_a02(lat2,lon2,nsig) )
      allocate( wt_num_a03(lat2,lon2,nsig), wt_num_a04(lat2,lon2,nsig) )

!      wt_mas_a01=zero; wt_mas_a02=zero; wt_mas_a03=zero; wt_mas_a04=zero
      wt_so4_a01=zero; wt_so4_a02=zero; wt_so4_a03=zero; wt_so4_a04=zero
      wt_no3_a01=zero; wt_no3_a02=zero; wt_no3_a03=zero; wt_no3_a04=zero
      wt_nh4_a01=zero; wt_nh4_a02=zero; wt_nh4_a03=zero; wt_nh4_a04=zero
      wt_ocx_a01=zero; wt_ocx_a02=zero; wt_ocx_a03=zero; wt_ocx_a04=zero
      wt_bcx_a01=zero; wt_bcx_a02=zero; wt_bcx_a03=zero; wt_bcx_a04=zero
      wt_clx_a01=zero; wt_clx_a02=zero; wt_clx_a03=zero; wt_clx_a04=zero
      wt_nax_a01=zero; wt_nax_a02=zero; wt_nax_a03=zero; wt_nax_a04=zero
      wt_oin_a01=zero; wt_oin_a02=zero; wt_oin_a03=zero; wt_oin_a04=zero
      wt_num_a01=zero; wt_num_a02=zero; wt_num_a03=zero; wt_num_a04=zero

      if( nsize_mosaic_wrf==8 ) then
      allocate( wt_so4_a05(lat2,lon2,nsig), wt_so4_a06(lat2,lon2,nsig) )
      allocate( wt_so4_a07(lat2,lon2,nsig), wt_so4_a08(lat2,lon2,nsig) )

      allocate( wt_no3_a05(lat2,lon2,nsig), wt_no3_a06(lat2,lon2,nsig) )
      allocate( wt_no3_a07(lat2,lon2,nsig), wt_no3_a08(lat2,lon2,nsig) )

      allocate( wt_nh4_a05(lat2,lon2,nsig), wt_nh4_a06(lat2,lon2,nsig) )
      allocate( wt_nh4_a07(lat2,lon2,nsig), wt_nh4_a08(lat2,lon2,nsig) )

      allocate( wt_ocx_a05(lat2,lon2,nsig), wt_ocx_a06(lat2,lon2,nsig) )
      allocate( wt_ocx_a07(lat2,lon2,nsig), wt_ocx_a08(lat2,lon2,nsig) )

      allocate( wt_bcx_a05(lat2,lon2,nsig), wt_bcx_a06(lat2,lon2,nsig) )
      allocate( wt_bcx_a07(lat2,lon2,nsig), wt_bcx_a08(lat2,lon2,nsig) )

      allocate( wt_clx_a05(lat2,lon2,nsig), wt_clx_a06(lat2,lon2,nsig) )
      allocate( wt_clx_a07(lat2,lon2,nsig), wt_clx_a08(lat2,lon2,nsig) )

      allocate( wt_nax_a05(lat2,lon2,nsig), wt_nax_a06(lat2,lon2,nsig) )
      allocate( wt_nax_a07(lat2,lon2,nsig), wt_nax_a08(lat2,lon2,nsig) )

      allocate( wt_oin_a05(lat2,lon2,nsig), wt_oin_a06(lat2,lon2,nsig) )
      allocate( wt_oin_a07(lat2,lon2,nsig), wt_oin_a08(lat2,lon2,nsig) )

      allocate( wt_num_a05(lat2,lon2,nsig), wt_num_a06(lat2,lon2,nsig) )
      allocate( wt_num_a07(lat2,lon2,nsig), wt_num_a08(lat2,lon2,nsig) )

      wt_so4_a05=zero; wt_so4_a06=zero; wt_so4_a07=zero; wt_so4_a08=zero
      wt_no3_a05=zero; wt_no3_a06=zero; wt_no3_a07=zero; wt_no3_a08=zero
      wt_nh4_a05=zero; wt_nh4_a06=zero; wt_nh4_a07=zero; wt_nh4_a08=zero
      wt_ocx_a05=zero; wt_ocx_a06=zero; wt_ocx_a07=zero; wt_ocx_a08=zero
      wt_bcx_a05=zero; wt_bcx_a06=zero; wt_bcx_a07=zero; wt_bcx_a08=zero
      wt_clx_a05=zero; wt_clx_a06=zero; wt_clx_a07=zero; wt_clx_a08=zero
      wt_nax_a05=zero; wt_nax_a06=zero; wt_nax_a07=zero; wt_nax_a08=zero
      wt_oin_a05=zero; wt_oin_a06=zero; wt_oin_a07=zero; wt_oin_a08=zero
      wt_num_a05=zero; wt_num_a06=zero; wt_num_a07=zero; wt_num_a08=zero
      end if
!!! cwy mosaic --------------------------------------------- chem
...
!!! cwy mosaic --------------------------------------------------- chem
!      deallocate( wt_mas_a01, wt_mas_a02, wt_mas_a03, wt_mas_a04 )
      deallocate( wt_so4_a01, wt_so4_a02, wt_so4_a03, wt_so4_a04 )
      deallocate( wt_no3_a01, wt_no3_a02, wt_no3_a03, wt_no3_a04 )
      deallocate( wt_nh4_a01, wt_nh4_a02, wt_nh4_a03, wt_nh4_a04 )
      deallocate( wt_ocx_a01, wt_ocx_a02, wt_ocx_a03, wt_ocx_a04 )
      deallocate( wt_bcx_a01, wt_bcx_a02, wt_bcx_a03, wt_bcx_a04 )
      deallocate( wt_clx_a01, wt_clx_a02, wt_clx_a03, wt_clx_a04 )
      deallocate( wt_nax_a01, wt_nax_a02, wt_nax_a03, wt_nax_a04 )
      deallocate( wt_oin_a01, wt_oin_a02, wt_oin_a03, wt_oin_a04 )
      deallocate( wt_num_a01, wt_num_a02, wt_num_a03, wt_num_a04 )

      if( nsize_mosaic_wrf==8 ) then
      deallocate( wt_so4_a05, wt_so4_a06, wt_so4_a07, wt_so4_a08 )
      deallocate( wt_no3_a05, wt_no3_a06, wt_no3_a07, wt_no3_a08 )
      deallocate( wt_nh4_a05, wt_nh4_a06, wt_nh4_a07, wt_nh4_a08 )
      deallocate( wt_ocx_a05, wt_ocx_a06, wt_ocx_a07, wt_ocx_a08 )
      deallocate( wt_bcx_a05, wt_bcx_a06, wt_bcx_a07, wt_bcx_a08 )
      deallocate( wt_clx_a05, wt_clx_a06, wt_clx_a07, wt_clx_a08 )
      deallocate( wt_nax_a05, wt_nax_a06, wt_nax_a07, wt_nax_a08 )
      deallocate( wt_oin_a05, wt_oin_a06, wt_oin_a07, wt_oin_a08 )
      deallocate( wt_num_a05, wt_num_a06, wt_num_a07, wt_num_a08 )
      end if
!!! cwy mosaic --------------------------------------------------- chem
