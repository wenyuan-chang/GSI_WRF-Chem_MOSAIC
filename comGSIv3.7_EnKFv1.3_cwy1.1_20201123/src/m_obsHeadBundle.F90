...
!!! cwy mosaic --------------------------------
    class(obsNode),pointer::  srfeabs => null()
    class(obsNode),pointer::  srfesca => null()
    class(obsNode),pointer::  srfeext => null()
!!! cwy mosaic --------------------------------
...
!!! cwy mosaic --------------------------------
  use m_obsdiags, only: srfeabshead     ! =39
  use m_obsdiags, only: srfescahead     ! =40
  use m_obsdiags, only: srfeexthead     ! =41
!!! cwy mosaic --------------------------------
...
!!! cwy mosaic --------------------------------
  ASSERT(ibin<=size( srfeabshead))
  ASSERT(ibin<=size( srfescahead))
  ASSERT(ibin<=size( srfeexthead))
!!! cwy mosaic --------------------------------
...
!!! cwy mosaic --------------------------------
  yobs%srfeabs  => obsLList_headNode( srfeabshead(ibin))  ! =39
  yobs%srfesca  => obsLList_headNode( srfescahead(ibin))  ! =40
  yobs%srfeext  => obsLList_headNode( srfeexthead(ibin))  ! =41
!!! cwy mosaic --------------------------------
return
