...
!$$$ end documentation block
  ...
  private
  public stpaod_srfeabs
  
contains
  
  subroutine stpaod_srfeabs(srfeabshead,rval,sval,out,sges,nstep)
...
!   if no aero data return
    if(.not. associated(srfeabshead))return
...
!          modify penalty term if nonlinear qc
  ...
  end subroutine stpaod_srfeabs

end module stpaodmod_srfeabs
