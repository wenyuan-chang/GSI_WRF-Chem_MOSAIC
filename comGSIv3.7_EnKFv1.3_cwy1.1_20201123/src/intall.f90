...
!!!      intliml,intjcpdry1,intjcpdry2,intjcdfi
  use intjcmod, only: intlimq,intlimg,intlimv,intlimp,intlimw10m,intlimhowv,intlimcldch,&
      intliml,intjcpdry1,intjcpdry2,intjcdfi, intlimnum
!!! cwy mosaic ------------------------------------------------------- chem
...
!!! cwy mosaic ------------------------------------------------------- chem
!    call intlimnum(rval(ibin_anl),sval(ibin_anl),ntguessig,'num_a01')
!    call intlimnum(rval(ibin_anl),sval(ibin_anl),ntguessig,'num_a02')
!    call intlimnum(rval(ibin_anl),sval(ibin_anl),ntguessig,'num_a03')
!    call intlimnum(rval(ibin_anl),sval(ibin_anl),ntguessig,'num_a04')
!!! cwy mosaic ------------------------------------------------------- chem
