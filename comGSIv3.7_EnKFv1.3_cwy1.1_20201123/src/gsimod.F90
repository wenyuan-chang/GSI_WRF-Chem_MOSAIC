...
!!! cwy mosaic ----------------------------------------------- chem
     rmin_value, sf_pm2p5, sf_pm10, sf_aodce318, sf_aodmodis, pm10bufr_only_coarse, &
     sf_srf_eabs, sf_srf_esca, sf_srf_eext, sf_jac, corr_length, &
     limit_srfeext, use_interbin_filter
!!! cwy mosaic ----------------------------------------------- chem
...
!!! cwy mosaic ----------------------------------------------- chem
     factmin_num, factmax_num, scalemin, scalemax
!!! cwy mosaic ----------------------------------------------- chem
...
!!! cwy mosaic ------------------------------
       factmin_num, factmax_num, scalemin, scalemax, rmin_value, &
       sf_pm2p5, sf_pm10, sf_aodce318, sf_aodmodis, pm10bufr_only_coarse, &
       sf_srf_eabs, sf_srf_esca, sf_srf_eext, sf_jac, corr_length, &
       limit_srfeext, use_interbin_filter
!!! cwy mosaic ------------------------------
...
!!! cwy mosaic ----------------------------------------------------- chem
!!!       laeroana_gocart, l_aoderr_table, aod_qa_limit, luse_deepblue,&
       laeroana_gocart, laeroana_mosaic, l_aoderr_table, aod_qa_limit, luse_deepblue,&   !!! read laeroana_xxx
!!! cwy mosaic ----------------------------------------------------- chem
...
! If this is a wrf regional run, then run interface with wrf
  update_pint=.false.
  if (regional) then
     if (fv3_regional) then             !!! fv3_regional=F
