...
! 2013-11-01 pagowski - add code for PM2.5 assimilation with wrf-chem
  ...
  !!! cwy mosaic ------------------------------- chem
  public  :: laeroana_mosaic
!  public  :: naero_mosaic_wrf
!  public  :: aeronames_mosaic_wrf

  logical :: laeroana_mosaic
  !!! cwy mosaic ------------------------------- chem
  ...
  real(r_kind),parameter :: pm2_5_teom_max=5000.0_r_kind !ug/m3
...
!accomodate, stands for maximum realistic value of surface pm2.5
  real(r_kind),parameter :: pm10_teom_max=5000.0_r_kind !ug/m3
...
!  !!! cwy mosaic ------------------------------- chem
!  integer(i_kind), parameter :: &
!!        naero_mosaic_wrf=40  !number of mosaic aerosol species
!        naero_mosaic_wrf=24  !number of mosaic aerosol species
!
!  character(len=max_varname_length), dimension(naero_mosaic_wrf), parameter :: &
!        aeronames_mosaic_wrf=(/&
!        'mas_a01','mas_a02','mas_a03','mas_a04','mas_a05','mas_a06','mas_a07','mas_a08',&
!!        'so4_a01','so4_a02','so4_a03','so4_a04',&
!!        'no3_a01','no3_a02','no3_a03','no3_a04',&
!!        'nh4_a01','nh4_a02','nh4_a03','nh4_a04',&
!!        'oc_a01 ','oc_a02 ','oc_a03 ','oc_a04 ',&
!!        'bc_a01 ','bc_a02 ','bc_a03 ','bc_a04 ',&
!!        'cl_a01 ','cl_a02 ','cl_a03 ','cl_a04 ',&
!!        'na_a01 ','na_a02 ','na_a03 ','na_a04 ',&
!!        'oin_a01','oin_a02','oin_a03','oin_a04',&
!        'num_a01','num_a02','num_a03','num_a04','num_a05','num_a06','num_a07','num_a08',&
!        'water_a01','water_a02','water_a03','water_a04','water_a05','water_a06','water_a07','water_a08'/)
!  !!! cwy mosaic ------------------------------- chem
