...
!!! cwy mosaic ------------------------
  type(obsLList),dimension(:),pointer :: srfeabshead => null()
  type(obsLList),dimension(:),pointer :: srfescahead => null()
  type(obsLList),dimension(:),pointer :: srfeexthead => null()
!!! cwy mosaic ------------------------
...
!!! cwy mosaic --------------------------------
 srfeabshead => ptr_obsbins_(obsllists,'srfeabs')
 srfescahead => ptr_obsbins_(obsllists,'srfesca')
 srfeexthead => ptr_obsbins_(obsllists,'srfeext')
!!! cwy mosaic --------------------------------
