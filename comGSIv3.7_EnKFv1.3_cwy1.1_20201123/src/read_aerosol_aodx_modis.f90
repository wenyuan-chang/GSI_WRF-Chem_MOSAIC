subroutine read_aerosol_aodx_modis(nread,ndata,nodata,jsatid,infile,gstime,lunout, &
...
!
        if (subset == 'NC008041') then
           write(6,*)'READ_AEROSOL_AODX_MODIS: MODIS data type, subset = ',subset
           ...
           write(6,'(''READ_AEROSOL_AODX_MODIS: aerosol bufr file '',a,''  date is '',i4,4i2.2,a)')trim(infile),iy,im,idd,ihh
           ...
           read_modis: do
              ...
              if ( aod_550>=100. .or. aod_550<=0. ) cycle read_modis
           ...
           write(6,*)'READ_AEROSOL_AODX_MODIS:  *** WARNING: unknown aerosol data type, subset=',subset
        ...
        write(6,*)'READ_AEROSOL_AODX_MODIS:  *** WARNING: read subset error, obstype=',obstype,', iret=',iret
     end if
     call closbf(lunin)
     close(lunin)
  else             ! obstype /= 'modis'
     write(6,*)'READ_AEROSOL_AODX_MODIS:  *** WARNING: unknown aerosol input type, obstype=',obstype
  endif

  ! Deallocate satthin arrays
  call destroygrids

end subroutine read_aerosol_aodx_modis
