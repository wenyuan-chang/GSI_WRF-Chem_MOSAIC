...
!$$$ end documentation block
  ...
  private
  public stpaod_srfesca
  
contains
  
  subroutine stpaod_srfesca(srfescahead,rval,sval,out,sges,nstep)
...
!   if no aero data return
    if(.not. associated(srfescahead))return
...
!          modify penalty term if nonlinear qc
  ...
  end subroutine stpaod_srfesca

end module stpaodmod_srfesca
