...
!!! cwy mosaic -------------------------------------
  use obsmod, only: iobsType_srfeabs  =>  i_srfeabs_ob_type
  use obsmod, only: iobsType_srfesca  =>  i_srfesca_ob_type
  use obsmod, only: iobsType_srfeext  =>  i_srfeext_ob_type
!!! cwy mosaic -------------------------------------
...
!!! cwy mosaic -----------------------------
  use m_srfeabsNode , only:  srfeabsNode ! 39
  use m_srfescaNode , only:  srfescaNode ! 40
  use m_srfeextNode , only:  srfeextNode ! 41
!!! cwy mosaic -----------------------------
...
!!! cwy mosaic -----------------------------
  type(srfeabsNode), target, save::  srfeabs_mold ! 39
  type(srfescaNode), target, save::  srfesca_mold ! 40
  type(srfeextNode), target, save::  srfeext_mold ! 41
!!! cwy mosaic -----------------------------
...
!!! cwy mosaic ---------------------------------------
  case("srfeabs" , "[srfeabsnode]"); index_ = iobsType_srfeabs
  case("srfesca" , "[srfescanode]"); index_ = iobsType_srfesca
  case("srfeext" , "[srfeextnode]"); index_ = iobsType_srfeext
!!! cwy mosaic ---------------------------------------
...
!!! cwy mosaic ---------------------------------------
  type is( srfeabsNode); index_ = iobstype_srfeabs
  type is( srfescaNode); index_ = iobstype_srfesca
  type is( srfeextNode); index_ = iobstype_srfeext
!!! cwy mosaic ---------------------------------------
...
!!! cwy mosaic ---------------------------------------
  case(iobsType_srfeabs ); obsmold_ =>  srfeabs_mold
  case(iobsType_srfesca ); obsmold_ =>  srfesca_mold
  case(iobsType_srfeext ); obsmold_ =>  srfeext_mold
!!! cwy mosaic ---------------------------------------
