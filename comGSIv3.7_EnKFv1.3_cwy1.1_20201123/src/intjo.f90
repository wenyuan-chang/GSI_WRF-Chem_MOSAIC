...
! RHS for conventional temperatures
  if( mype==0 ) write(*,*) 'associated(yobs%t)=', associated(yobs%t)
  if (ntclen>0) then
...
! RHS for conventional moisture
  if( mype==0 ) write(*,*) 'associated(yobs%q)=', associated(yobs%q)
...
!!! cwy --------------------------------------------------------------------
! RHS for pm2_5
  if( mype==0 ) write(*,*) 'associated(yobs%pm2_5)=', associated(yobs%pm2_5)
  call intpm2_5(yobs%pm2_5,rval,sval)

! RHS for pm10
  if( mype==0 ) write(*,*) 'associated(yobs%pm10)=', associated(yobs%pm10)
  call intpm10(yobs%pm10,rval,sval)
!!! cwy --------------------------------------------------------------------

!!! cwy --------------------------------------------------------------------
! RHS for surface pressure observations
  if( mype==0 ) write(*,*) 'associated(yobs%ps)=', associated(yobs%ps)
...
! RHS calculation for srf eabs
  if( mype==0 ) write(*,*) 'associated(yobs%srfeabs)=', associated(yobs%srfeabs)
  call intaod_srfeabs(yobs%srfeabs,rval,sval)

! RHS calculation for srf esca
  if( mype==0 ) write(*,*) 'associated(yobs%srfesca)=', associated(yobs%srfesca)
  call intaod_srfesca(yobs%srfesca,rval,sval)

! RHS calculation for srf eext
