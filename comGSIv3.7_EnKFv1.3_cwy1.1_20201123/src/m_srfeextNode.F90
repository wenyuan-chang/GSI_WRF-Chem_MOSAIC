...
! module interface:
  ...
  type,extends(obsNode):: srfeextNode
  ...
  end type srfeextNode

  public:: srfeextNode_typecast
  public:: srfeextNode_nextcast
        interface srfeextNode_typecast; module procedure typecast_ ; end interface
        interface srfeextNode_nextcast; module procedure nextcast_ ; end interface

  character(len=*),parameter:: MYNAME="m_srfeextNode"
...
subroutine obsNode_clean_(aNode)
  implicit none
  class(srfeextNode),intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(srfeextNode),intent(in):: aNode
