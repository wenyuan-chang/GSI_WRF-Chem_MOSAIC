...
! module interface:
  ...
  type,extends(obsNode):: srfeabsNode
  ...
  end type srfeabsNode

  public:: srfeabsNode_typecast
  public:: srfeabsNode_nextcast
        interface srfeabsNode_typecast; module procedure typecast_ ; end interface
        interface srfeabsNode_nextcast; module procedure nextcast_ ; end interface

  character(len=*),parameter:: MYNAME="m_srfeabsNode"
...
subroutine obsNode_clean_(aNode)
  implicit none
  class(srfeabsNode),intent(inout):: aNode
...
subroutine obsNode_xwrite_(aNode,junit,jstat)
  implicit none
  class(srfeabsNode),intent(in):: aNode
